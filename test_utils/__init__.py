        ...
        for db in cls._databases():
            if hasattr(cls, 'fixtures') and \
               getattr(cls, '_fb_should_setup_fixtures', True):
                # If the fixture-grouping test runner advises us that it's
                # already set up these fixtures, don't do it again.
    ...
    def _fixture_teardown(cls):
        ...
        if hasattr(cls, 'fixtures') and \
           getattr(cls, '_fb_should_teardown_fixtures', True):
            # If the fixture-grouping test runner advises us that the next test
